...
function mirrorLink(link, root) {
    const href = link.href;
    if (!href)
        return;
    if (root.querySelector(`link[${MARK}][href="${CSS.escape(href)}"]`))
        return;
...
//# sourceMappingURL=GlobalStyleBridge.js.map