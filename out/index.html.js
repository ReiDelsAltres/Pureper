...
TripletBuilder.create("./src/components/NavigationDrawer.html", "./src/components/NavigationDrawer.html.css", "./src/components/NavigationDrawer.html.ts")
...
TripletBuilder.create("./src/components/PageLayout.html", "./src/components/PageLayout.html.css")
    .withAccess(AccessType.BOTH)
    .build()
    .register("markup", "page-layout");
TripletBuilder.create("./src/components/ColorPalettePreview.html", "./src/components/ColorPalettePreview.html.css", "./src/components/ColorPalettePreview.html.js")
    .withAccess(AccessType.BOTH)
    .withUni(ColorPalettePreview)
    .build()
    .register("markup", "color-palette");
TripletBuilder.create("./src/components/SvgIcon.html", "./src/components/SvgIcon.html.css", "./src/components/SvgIcon.html.js")
    .withAccess(AccessType.BOTH)
    .withUni(SvgIcon)
    .build()
    .register("markup", "svg-icon");
TripletBuilder.create("./src/components/ReButton.html", "./src/components/ReButton.html.css", "./src/components/ReButton.html.js")
    .withAccess(AccessType.BOTH)
    .withUni(ReButton)
    .build()
...
TripletBuilder.create("./pages/MainPage.html")
    .withAccess(AccessType.BOTH)
    .build()
    .register("router", "/");
TripletBuilder.create("./pages/PalettePage.html", "./pages/PalettePage.html.css", "./pages/PalettePage.html.js")
    .withAccess(AccessType.BOTH)
    .withUni(PalettePage)
    .build()
