...
export default class UniHtml {
     ...
     */
    protected preLoad(template: TemplateInstance): Promise<void>;
    /**
     ...
     */
    protected postLoad(template: TemplateInstance): Promise<void>;
    /**
     ...
     */
    protected render(template: TemplateInstance, renderTarget: HTMLElement | DocumentFragment): Promise<void>;
}
