...
export default class DebuggerSubPage extends Page {
    ...
    generateOptionsPanel(component) {
        ...
        Object.entries(component.attributes || {}).forEach(([attrName, attrConfig]) => {
            const section = this.createOptionSection(this.capitalizeFirst(attrName.replace(/[-_]/g, ' ')), attrConfig.type, attrName, attrConfig);
    ...
    renderComponent() {
        ...
        try {
            const componentElement = this.createComponentElement(config, 'Тестовый компонент');
...
//# sourceMappingURL=DebuggerSubPage.html.js.map